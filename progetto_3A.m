...
%3 Il sistema pu`o accettare un sovraelongazione percentuale al massimo dell’5% : S_% <= 5%
%4 Il tempo di assestamento all’ h% pu`o essere tenuto relativamente basso T_a_h_perc = T_a[s]
